...
export default function TodayScreen() {
  ...
  const exportLocalGraph = useCallback(async () => {
    ...
    try {
      ...
      setExportStatus(await persistLocalExport({ format: isProtectedExport ? "protected-zip" : "complete-zip", filename: bundleFilename, conceptCount: allConcepts.length, connectionCount: allConnections.length }));
      setExportPassphrase("");
...
function PopulatedDashboard({ concepts, relationships, backupSummary, onQuickRun, quickRunState, quickRunMessage, quickRunProgress, onExport, exportState, exportMessage, exportStatus, onOpenHistory, onToggleExportReminders, isProtectedExport, exportPassphrase, exportPassphraseConfirmation, exportRecoveryHint, onToggleExportProtection, onChangeExportPassphrase, onChangeExportPassphraseConfirmation, onChangeExportRecoveryHint }: { concepts: number; relationships: number; backupSummary: BackupStatusSummary | null; onQuickRun: () => void; quickRunState: "idle" | "running"; quickRunMessage: string; quickRunProgress: SyncProgressState; onExport: () => void; exportState: HomeLocalExportState; exportMessage: string; exportStatus: LocalExportStatus; onOpenHistory: () => void; onToggleExportReminders: () => void; isProtectedExport: boolean; exportPassphrase: string; exportPassphraseConfirmation: string; exportRecoveryHint: string; onToggleExportProtection: () => void; onChangeExportPassphrase: (value: string) => void; onChangeExportPassphraseConfirmation: (value: string) => void; onChangeExportRecoveryHint: (value: string) => void }) {
